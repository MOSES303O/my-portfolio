...
const SocialLinks = () => {
  ...
  return (
    <div className="w-full bg-linear-to-br from-white/10 to-white/5 rounded-3xl p-6 py-8 backdrop-blur-xl border border-white/10">
      <h3
      ...
      <div className="flex flex-col gap-4">
        ...
        {linkedIn && (
          <a
            ...
            className="group relative flex items-center justify-between p-5 rounded-2xl bg-white/5 border border-white/10 hover:border-white/20 transition-all duration-500 overflow-hidden"
            data-aos="fade-up"
            data-aos-delay="100"
          >
            <div className={`absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500 bg-linear-to-r ${linkedIn.gradient}`} />

            <div className="relative flex items-center gap-4">
              <div className="relative flex items-center justify-center">
                <div className="absolute inset-0 opacity-20 rounded-xl transition-all duration-500 group-hover:scale-110" style={{ backgroundColor: linkedIn.color }} />
                <div className="relative p-3 rounded-xl">
                  <linkedIn.icon className="w-7 h-7 transition-all duration-500 group-hover:scale-105" style={{ color: linkedIn.color }} />
                </div>
              </div>
            ...
            <ExternalLink className="w-5 h-5 text-gray-500 group-hover:text-white opacity-0 group-hover:opacity-100 transition-all duration-300" />
          </a>
        )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[instagram, youtube].map((link, index) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative flex items-center gap-4 p-5 rounded-2xl bg-white/5 border border-white/10 hover:border-white/20 transition-all duration-500 overflow-hidden"
              data-aos="fade-up"
            ...
            >
              ...
              <div className="relative flex items-center justify-center">
                <div className="absolute inset-0 opacity-20 rounded-xl transition-all duration-500 group-hover:scale-125" style={{ backgroundColor: link.color }} />
                <div className="relative p-3 rounded-xl">
                  <link.icon className="w-6 h-6 transition-all duration-500 group-hover:scale-110" style={{ color: link.color }} />
                </div>
              </div>
              ...
              <div className="flex flex-col min-w-0">
                ...
                <span className="text-sm text-gray-400 truncate group-hover:text-gray-300 transition-colors">
                  {link.subText}
                </span>
              </div>

              <ExternalLink className="w-5 h-5 text-gray-500 group-hover:text-white ml-auto opacity-0 group-hover:opacity-100 transition-all" />
            </a>
          ))}
        </div>
