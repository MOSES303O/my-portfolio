...
const TechBadge = ({ tech }: TechBadgeProps) => {
  ...
  return (
    <div className="group relative overflow-hidden px-3 py-2 md:px-4 md:py-2.5 bg-linear-to-r from-blue-600/10 to-purple-600/10 rounded-xl border border-blue-500/10 hover:border-blue-500/30 transition-all duration-300 cursor-default">
  ...
  return (
    <li className="group flex items-start space-x-3 p-2.5 md:p-3.5 rounded-xl hover:bg-white/5 transition-all duration-300 border border-transparent hover:border-white/10">
      <div className="relative mt-2">
        ...
        <div className="relative w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-linear-to-r from-blue-400 to-purple-400 group-hover:scale-125 transition-transform duration-300" />
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
          ...
          <div className="flex items-center space-x-2 md:space-x-4 mb-8 md:mb-12 animate-fadeIn">
            ...
            <div className="flex items-center space-x-1 md:space-x-2 text-sm md:text-base text-white/50">
              ...
              <span className="text-white/90 truncate">{enhancedProject.Title}</span>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <ProjectStats project={enhancedProject} />

              {/* Action Buttons */}
              <div className="flex flex-wrap gap-3 md:gap-4">
                {enhancedProject.Link && (
                  <a
                    href={enhancedProject.Link}
                    target="_blank"
                ...
                <a
                  ...
                  onClick={(e) => {
                    if (!handleGithubClick(enhancedProject.Github)) e.preventDefault();
                  }}
                >
                  <GitBranch className="relative w-4 h-4 md:w-5 md:h-5 group-hover:rotate-12 transition-transform" />
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInRight">
              {enhancedProject.Img && (
                <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl group">
                  ...
                  <Image
                    src={enhancedProject.Img}
                    alt={enhancedProject.Title}
                    width={800}
                    height={600}
              ...
              <div className="bg-white/2 backdrop-blur-xl rounded-2xl p-8 border border-white/10 space-y-6 hover:border-white/20 transition-colors duration-300 group">
                <h3 className="text-xl font-semibold text-white/90 flex items-center gap-3">
                  <Star className="w-5 h-5 text-yellow-400 group-hover:rotate-20 transition-transform duration-300" />
                  Key Features
                </h3>
